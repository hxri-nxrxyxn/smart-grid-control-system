...
user_input_date = input("Enter a future date (YYYY-MM-DD): ")  # User is prompted to input a date
user_input_city = input("Enter city name (e.g., Valencia): ")  # User is prompted to input city name
try:
